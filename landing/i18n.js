...
(function () {
  ...
  var dict = {
    pt: {
      ...
      "cronicas.c1.body": "Repositório público, README que também é landing, e o vídeo do Lote 3 recuperado da Files API do Gemini antes de expirar.",
      "cronicas.c2.tag": "Sessão 14",
      "cronicas.c2.title": "O fim dos hologramas",
      "cronicas.c2.body": "Unidades passam a deslizar, parar e contornar construções e veios — colisão com prova numérica: 8,7 m no Centro de Comando, 3,1 m no veio.",
      "cronicas.c3.tag": "Sessões 15–16",
      "cronicas.c3.title": "Uma única verdade",
      "cronicas.c3.body": "O workspace compartilhado unifica tipos, custos e tempos; o servidor passa a debitar recursos, respeitar o teto populacional e reembolsar cancelamentos.",
      "cronicas.c4.tag": "Sessão 17",
      "cronicas.c4.title": "Reconciliação: coleta, inércia e limites",
      "cronicas.c4.body": "Coleta a 3,33 un/s, física inercial no servidor, entrega a 10 m e mundo de ±88 m — com o contrato de testes congelado antes da implementação e a evidência visual registrada.",
    ...
    en: {
      ...
      "cronicas.c1.body": "A public repository, a README that doubles as a landing page, and the Batch 3 video recovered from the Gemini Files API before it expired.",
      "cronicas.c2.tag": "Session 14",
      "cronicas.c2.title": "The end of holograms",
      "cronicas.c2.body": "Units now slide, stop and steer around buildings and veins — collision with numerical proof: 8.7 m at the Command Center, 3.1 m at the vein.",
      "cronicas.c3.tag": "Sessions 15–16",
      "cronicas.c3.title": "A single truth",
      "cronicas.c3.body": "The shared workspace unifies types, costs and timings; the server now debits resources, enforces the population cap and refunds cancellations.",
      "cronicas.c4.tag": "Session 17",
      "cronicas.c4.title": "Reconciliation: gathering, inertia and limits",
      "cronicas.c4.body": "Gathering at 3.33/s, inertial physics on the server, 10 m dropoff and a ±88 m world — with the test contract frozen before implementation and visual evidence recorded.",

...
> **Próximo passo obrigatório**: iniciar a **sub-fase 2.6.2** (paridade de modelo: custos, POP, cancelamento v2 e tempos no servidor) — decisões 2.6.x **fechadas 7/7** em 2026-09-11.
